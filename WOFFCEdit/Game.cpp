...
void Game::Update(DX::StepTimer const& timer)
{
	...
	//mouseX = m_InputCommands.mouseX; 
	//mouseY = m_InputCommands.mouseY; 

	//// Mouse inputs
	////m_camOrientation.y = -m_InputCommands.mouseX;
	////m_camOrientation.x = m_InputCommands.mouseY; 
	//m_camOrientation.x = mouseY; 
	//m_camOrientation.y = -mouseX;
...
int Game::MousePicking()
{
	...
	// setup near and far plane of frustum with mouseX and mouseY passed down from ToolMain. 
	...
	for (int i = 0; i < m_displayList.size(); i++)
	{
		...
		// turn the transformed points into out picking vector. 
